...
import checkers.database.table.Checker;
import checkers.database.table.Log;
import checkers.database.table.Play;
import checkers.database.table.Server;
import checkers.database.table.User;
import checkers.database.table.UserPassword;
